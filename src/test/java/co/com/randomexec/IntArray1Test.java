...
import co.com.randomexec.arrays.IntArray1;
...
@DisplayNameGeneration(ReplaceCamelCase1.class)
    ...
    void theDistanceBetweenTheFirstAndTheLastEntryOfTheMaximumValueIsCalculated() {
        {
            int[] array = null;
            int expected = 0;
            int actual = IntArray1.maximumDistance(array);
...
class ReplaceCamelCase1 extends DisplayNameGenerator.Standard {
    @Override
